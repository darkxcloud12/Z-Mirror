...
def start(update, context):
    ...
    buttons.buildbutton("Updates", "https://t.me/DarkXUpdates")
    buttons.buildbutton("Mirror Group", "https://t.me/DarkXUpdates")
    buttons.buildbutton("Owner", "https://t.me/darksun12")
